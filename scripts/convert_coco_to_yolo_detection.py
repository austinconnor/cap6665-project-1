...
def main() -> None:
    parser = argparse.ArgumentParser(description="Convert local COCO annotations to YOLO detection format.")
    parser.add_argument("--data-root", default="data")
    parser.add_argument("--output-root", default="data/yolo_detection")
