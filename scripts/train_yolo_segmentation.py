...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train YOLO26m-seg document layout segmenter on CUDA.")
    parser.add_argument("--data", default="data/yolo_segmentation/dataset_segmentation.yaml")
    parser.add_argument("--model", default="models/yolo26m-seg.pt")
    parser.add_argument("--project", default="outputs/training")
    parser.add_argument("--name", default="yolo26m_segmentation")
